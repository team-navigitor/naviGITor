        ...
        <div className='side-nav-bar-container'>
          ...
          <div className='nav-links-container'>
            <ul className='fa-ul'>
              ...
              <li><i className="fa-li fa fa-tree" aria-hidden="true"></i><Link className='list' to='/Main/GitTree'>Global Git Tree</Link></li>
              <li><i className="fa-li fa fa-code-fork" aria-hidden="true"></i><Link className='list' to='/Main/LocalGitTree'>Local Git Tree</Link></li>
